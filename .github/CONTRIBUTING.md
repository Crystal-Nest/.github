...
`.editorconfig` file exported from our IntelliJ IDEA environment:
```
[*]
charset = utf-8
end_of_line = crlf
...
ij_groovy_class_count_to_use_import_on_demand = 10
...
ij_groovy_names_count_to_use_import_on_demand = 5
